          ...
          {results.map((movie, idx) => (
            ...
            >
              <div className="relative h-80 md:h-80">
                ...
                <p className="absolute bottom-2 right-2 bg-gradient-to-br from-yellow-400 to-orange-500 text-[#1a2a3a] text-xs font-bold px-2 py-1 rounded-full shadow-md">
                  {movie.time || "--"}
                </p>
              ...
              <div className="p-3">
                <h3 className="text-white text-base font-bold truncate">{movie.name}</h3>
                <p className="text-gray-400 text-xs italic truncate">{movie.original_name}</p>
